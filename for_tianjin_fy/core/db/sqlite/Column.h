...
SQLITE_EXPORT extern const int INTEGER;   ///< SQLITE_INTEGER
SQLITE_EXPORT extern const int FLOAT;     ///< SQLITE_FLOAT
SQLITE_EXPORT extern const int TEXT;      ///< SQLITE_TEXT
SQLITE_EXPORT extern const int BLOB;      ///< SQLITE_BLOB
SQLITE_EXPORT extern const int Null;      ///< SQLITE_NULL
