...
SQLITE_EXPORT extern const int OPEN_READONLY;     // SQLITE_OPEN_READONLY
...
SQLITE_EXPORT extern const int OPEN_READWRITE;    // SQLITE_OPEN_READWRITE
/// With OPEN_READWRITE: The database is opened for reading and writing, and is created if it does not already exist.
SQLITE_EXPORT extern const int OPEN_CREATE;       // SQLITE_OPEN_CREATE
/// Open database with thread-safety
SQLITE_EXPORT extern const int OPEN_FULLMUTEX;    // SQLITE_OPEN_FULLMUTEX

/// Enable URI filename interpretation, parsed according to RFC 3986 (ex. "file:data.db?mode=ro&cache=private")
SQLITE_EXPORT extern const int OPEN_URI;          // SQLITE_OPEN_URI

SQLITE_EXPORT extern const int OK;                ///< SQLITE_OK (used by check() bellow)

SQLITE_EXPORT extern const char*  VERSION;        ///< SQLITE_VERSION string from the sqlite3.h used at compile time
SQLITE_EXPORT extern const int    VERSION_NUMBER; ///< SQLITE_VERSION_NUMBER from the sqlite3.h used at compile time
